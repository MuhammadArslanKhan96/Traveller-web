  ...
  return (
    <>
      ...
      {showPopup && <div className='fixed top-0 min-h-screen flex justify-center items-center w-[99vw] bg-black/70'>
        {showPopup !== 'travelers' ? <LocationSelector selectValue={selectValue} setFilterCities={setFilterCities} filterCities={filterCities} filteredCountries={filteredCountries} /> : <NumberOfPeople travelers={travelers} selectValue={selectValue} />}
      </div>}
    </>
  )
}
